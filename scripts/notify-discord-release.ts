  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Cafe Code prerelease is available for nightly testers."
          : "A new Cafe Code latest release is available.",
...
).pipe(Command.withDescription("Post a Cafe Code release announcement to Discord."));
