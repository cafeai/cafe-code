export const BRAND_ASSET_PATHS = {
  ...
  productionWindowsIconIco: "assets/prod/cafe-code-black-windows.ico",
  productionWebFaviconIco: "assets/prod/cafe-code-black-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/cafe-code-black-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/cafe-code-black-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/cafe-code-black-web-apple-touch-180.png",
