...
export const RELEASE_UPDATE_STATE_CHANNEL = "desktop:release-update-state";
export const RELEASE_UPDATE_GET_STATE_CHANNEL = "desktop:release-update-get-state";
export const RELEASE_UPDATE_CHECK_CHANNEL = "desktop:release-update-check";
