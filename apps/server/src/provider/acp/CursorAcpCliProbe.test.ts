 ...
 * Enable with: CAFE_CODE_CURSOR_ACP_PROBE=1 bun run test --filter CursorAcpCliProbe
 */
...
describe.runIf(process.env.CAFE_CODE_CURSOR_ACP_PROBE === "1")("Cursor ACP CLI probe", () => {
