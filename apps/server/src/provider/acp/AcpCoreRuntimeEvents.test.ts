import { ProviderDriverKind, RuntimeRequestId, TurnId } from "@cafecode/contracts";
...
describe("AcpCoreRuntimeEvents", () => {
  const acpProvider = ProviderDriverKind.make("acpAgent");
