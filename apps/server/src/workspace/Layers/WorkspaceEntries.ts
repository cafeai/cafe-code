...
import { type FilesystemBrowseInput, type ProjectEntry } from "@cafecode/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@cafecode/shared/path";
import {
  insertRankedSearchResult,
  normalizeSearchQuery,
  scoreQueryMatch,
  type RankedSearchResult,
} from "@cafecode/shared/searchRanking";
