...
import { GitCommandError, type VcsRef } from "@cafecode/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@cafecode/shared/git";
import { compactTraceAttributes } from "@cafecode/shared/observability";
import { decodeJsonResult } from "@cafecode/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `cafecode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
