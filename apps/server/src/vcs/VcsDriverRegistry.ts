...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@cafecode/contracts";
import { VcsUnsupportedOperationError } from "@cafecode/contracts";
...
export class VcsDriverRegistry extends Context.Service<VcsDriverRegistry, VcsDriverRegistryShape>()(
  "cafecode/vcs/VcsDriverRegistry",
) {}
