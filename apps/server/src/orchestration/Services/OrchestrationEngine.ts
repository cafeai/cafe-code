...
export interface OrchestrationEngineShape {
   ...
   * @param limit - Optional bounded page size, including exact single-event reads.
...
>()("cafecode/orchestration/Services/OrchestrationEngine/OrchestrationEngineService") {}
